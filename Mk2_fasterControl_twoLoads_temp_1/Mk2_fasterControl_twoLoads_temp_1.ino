...
//
constexpr float powerCal_grid{0.05332};     /**< for CT1 */
constexpr float powerCal_diverted{0.05555}; /**< for CT2 */
...
// close to unity.
constexpr float f_voltageCal{1.015f}; /**< compared with Fluke 77 meter */
