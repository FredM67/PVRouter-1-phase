...
enum LEDforCT1_states
{
  LED_ON_FOR_CT1,
  LED_OFF_FOR_CT1
};  // active low for use at the "trigger" port
enum LEDforCT2_states
{
  LED_OFF_FOR_CT2,
  LED_ON_FOR_CT2
};  // active high for use at the "mode" port
enum resetLineStates
{
  ACTIVE,
  INACTIVE
};
...
void setup()
{
  ...
  Serial.print("powerCal_forCT1 =      ");
  Serial.println(powerCal_forCT1, 4);
  Serial.print("powerCal_forCT2 = ");
  Serial.println(powerCal_forCT2, 4);
